...
public class GaraCavalli extends JFrame {
    ...
    public static int numCav = 3; //variabile che seleziona il num di cavalli
    ...
    public GaraCavalli() {
        ...
        pista = new Campo();
        partecipanti = new Cavallo[numCav]; 
        thread_partecipanti = new CavalliInGara[numCav];
        posizione = 1;

        int partenza = 15;
        for (int xx = 0; xx < numCav; xx++) {
    ...
    public void visualizzaClassifica() {
        ...
        classifica.getContentPane().setLayout(new GridLayout(numCav, 1)); 

        for (int xx = 1; xx < numCav + 1; xx++) { 
            for (int yy = 0; yy < numCav; yy++) { 
